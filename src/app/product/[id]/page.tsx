    ...
    <div className="container mx-auto px-4 py-8 mt-20 max-w-7xl">
        ...
        <div className="bg-white border border-gray-200 rounded-[2rem] p-6 lg:p-10 shadow-sm mb-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                ...
                {/* --- IMAGE SECTION --- */}
                <div>
                    <div className="relative aspect-[3/4] bg-gradient-to-b from-white to-gray-100 rounded-2xl overflow-hidden shadow-inner border border-gray-100 mx-auto max-w-[400px]">
                        <img 
                          src={selectedImage}
                          alt={product.name} 
